...
public class MainActivity extends ListActivity {
	...
	String classes[] = {"SobreMi","Calculadora", "WeightSum","Camara","Form","BundleSender",
			"GFX","GFXSurface","GFXSurface2","LongClick","Tabs","SimpleBrowser","Flipper",
			"InternalData"};
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		try{
			Class ourClass = Class.forName("com.maxwell.android_examples." + selClass);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.sobreMi:
			Intent i = new Intent("com.maxwell.android_examples.ABOUT");
			startActivity(i);
			break;
		case R.id.preferencias:
			Intent e = new Intent("com.maxwell.android_examples.PREFS");
			startActivity(e); 
			break;
		case R.id.exit:
			finish();
